      ...
      <Col span={8}>
        ...
        >
          <Form.Item
            ...
            name="url"
            rules={[
              { required: true, message: 'Please input your url profile!' },
            ]}
          >
            <Input
          ...
          >
            <Input
              ...
              defaultValue={user?.result?.name || user?.name}
            />
          </Form.Item>
          <Form.Item
            // label="Email"
          ...
          >
            ...
            <TextArea
              ...
              defaultValue={user?.result?.bio || user?.bio}
            />
          </Form.Item>
          ...
          >
            <Input
              placeholder="Email"
              defaultValue={user?.result?.email || user.email}
            />
          </Form.Item>
          <Form.Item
            // label="Password"
